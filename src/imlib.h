...
//bool bmp_read_geometry(FIL *fp, image_t *img, bmp_read_settings_t *rs);
bool bmp_read_pixels(FIL *fp, image_t *img, int line_start, int line_end, bmp_read_settings_t *rs);
void bmp_read(image_t *img, const char *path);
void bmp_write_subimg(image_t *img, const char *path, rectangle_t *r);
//bool jpeg_compress(image_t *src, image_t *dst, int quality, bool realloc);
//void jpeg_read_geometry(FIL *fp, image_t *img);
//bool jpeg_read_pixels(FIL *fp, image_t *img);
...
void imlib_draw_string(image_t *img, int x_off, int y_off, const char *str, int c, float scale, int x_spacing, int y_spacing, bool mono_space);////////edirtt
...
image_t* imlib_image_create(int w, int h,image_bpp_t bpp,  uint32_t size, void *pixels, bool is_data_alloc);
